 ...
 * @version $Id: confirm_track_sub.php 2016-04-30 10:58:16Z webchills $
 */

// Include application configuration parameters
require('includes/application_top.php');
require(DIR_FS_CATALOG . 'includes/database_tables.php');
require('includes/extra_datafiles/dropshipping.php');
require('includes/languages/english/extra_definitions/dropshipping.php');
